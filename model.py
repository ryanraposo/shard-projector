...
class ServerControl:
    ...
    def initialize_ui(self):
        ...
        self.console_view_master = widgets.WidgetConsoleView(
            self.console_view_frame, width=cv_width, height_in_rows=cv_height_in_rows
        )
        self.console_view_master.pack(side=tk.LEFT)
        self.console_view_slave = widgets.WidgetConsoleView(
            self.console_view_frame, width=cv_width, height_in_rows=cv_height_in_rows
        )
    ...
    def update_info_bar(self):
        ...
        self.info_bar.name_info_value.configure(text=dict_server_config["NETWORK"]["cluster_name"])
        self.info_bar.gamemode_info_value.configure(
            text=dict_server_config["GAMEPLAY"]["game_mode"]
        )
        self.info_bar.players_info_value.configure(
            text=dict_server_config["GAMEPLAY"]["max_players"]
        )
