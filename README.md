...
So, the 'good times' for each project (read: life? need more data LOL but allow me the stretch while life=projects until paycheques in mailbox) are unpredictable, my gut says that will never change, and today in a rare twist: it was nice.
